...
** Basic settings
:LOGBOOK:
CLOCK: [2020-05-01 Fri 10:32]--[2020-05-01 Fri 10:35] =>  0:03
CLOCK: [2020-05-01 Fri 09:59]--[2020-05-01 Fri 10:14] =>  0:15
:END:
#+begin_src emacs-lisp :tangle yes
...
(defun load-mu4e ()
  ...
  (setq mu4e-get-mail-command "mbsync -c ~/.emacs.d/mu4e/.mbsyncrc -a"
        ;; mu4e-html2text-command "w3m -T text/html" ;; sing the default mu4e-shr2text
  ...
  (add-hook 'mu4e-compose-mode-hook
            (defun my-do-compose-stuff ()
              ...
              (use-hard-newlines -1)
              (flyspell-mode)))
  ;; et up queue for offline email
  ;; se mu mkdir  ~/Maildir/acc/queue to set up first
  (setq smtpmail-queue-mail nil)  ;; start in normal mode
  ;; ename files when moving
  ;; EEDED FOR MBSYNC
...
** Context settings.
:LOGBOOK:
CLOCK: [2020-05-01 Fri 10:48]--[2020-05-01 Fri 10:54] =>  0:06
:END:
#+begin_src emacs-lisp :tangle yes
;; mu4e-context
...
(add-to-list 'mu4e-bookmarks
             (make-mu4e-bookmark
              ...
              :query "date:7d..now AND flag:unread AND maildir:/uq/INBOX OR maildir:/QUT/INBOX"
              :key ?U))
...
(setq mu4e-user-mail-address-list
      (with-temp-buffer
        (insert-file-contents "~/.emacs.d/mu4e/.my-emails")
...
;; capture
(setq org-default-notes-file (concat org-directory "/brain/inbox.org"))
...
(setq org-agenda-files (append org-agenda-files '("/home/thomas/.emacs.d/yaoni.org")))
...
(use-package org-brain :ensure t
  :init
  (setq org-brain-path (concat (get-wd) "/orgs"))
  ;; For Evil users
...
** org-roam
:LOGBOOK:
CLOCK: [2021-01-13 Wed 08:44]--[2021-01-13 Wed 22:08] => 13:24
:END:
#+begin_src emacs-lisp :tangle yes
...
#+end_src
** Save auto-save files in a dedicated folder
#+begin_src emacs-lisp :tangle yes
