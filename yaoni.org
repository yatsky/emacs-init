...
* deno-bridge
#+begin_src emacs-lisp :tangle yes
(add-to-list 'load-path "~/.emacs.d/other-packages/deno-bridge")
...
* deno-bridge-jieba
#+begin_src emacs-lisp :tangle yes
(add-to-list 'load-path (expand-file-name "~/.emacs.d/other-packages/deno-bridge-jieba"))
...
#+begin_src emacs-lisp :tangle yes
(add-to-list 'load-path "~/.emacs.d/other-packages/blink-search")
