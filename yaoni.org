...
(use-package vc-msg
  :straight
    (:host github :repo "redguardtoo/vc-msg" :branch "master" :files ("*.el" "out"))
  :defer t)
#+end_src
* Miscellaneous setup
...
(defun get-org-excerpt ()
  ...
  (with-current-buffer (current-buffer)
    ...
    (lambda(para) (substring (buffer-string) (1- (plist-get (cadr para) :begin)) (1- (plist-get (cadr para) :end))))
    nil
    t))))
