...
(setq-default indent-tabs-mode nil)  ; Use spaces instead of tabs globally by default
;; (setq sqlformat-command 'sqlfluff)
;; (setq sqlformat-args nil)
;; (setq sqlformat-args '("--config" "/Users/ethan.wang/Dev/sqlfluff/.sqlfluff" "--FIX-EVEN-UNPARSABLE"))
;; (add-hook 'sql-mode-hook 'sqlformat-on-save-mode)
;; (remove-hook 'sql-mode-hook 'sqlformat-on-save-mode)
#+end_src
...
* lsp-bridge
:LOGBOOK:
CLOCK: [2024-01-12 Fri 23:26]--[2024-01-12 Fri 23:31] =>  0:05
...
ssh-add id_rsa
#+end_src
then restart lsp-bridge
cannot restart lsp-bridge once the ssh connection is established
...
(setq lsp-bridge-user-ssh-private-key "~/.ssh/id_rsa_home_office")
(setq
...
(setq acm-completion-backend-merge-order
      '("template-first-part-candidates" "mode-first-part-candidates" "tabnine-candidates" "copilot-candidates" "codeium-candidates" "template-second-part-candidates" "mode-second-part-candidates"))
...
(use-package blink-search
  ...
  (setq blink-search-browser-function 'browse-url-macosx-edge-browser)
